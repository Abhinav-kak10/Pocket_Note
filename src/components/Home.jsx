...
import BG_IMG from "../assets/home.png";

const Home = ({noteActive,isPhone}) => {
  ...
  return (
    <div className={`home ${noteGroups && isPhone && noteGroups.length>0 ? "none" : "flex"}`}>
      <img src={BG_IMG} alt="home" width="400px" className="homeImg" />
      <p className="homeTitle">Pocket Notes</p>
      <p className="homeDescription">
      Send and receive messages without an internet connection in this app <br/>
      Stay connected and access your messages offline, anytime, anywhere.
      </p>
      <p className="homeBottom flex flex-row">
        <svg
